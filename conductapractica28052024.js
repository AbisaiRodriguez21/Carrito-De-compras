...
function mostrarEnCarro(){
    ...
    for(var i = 0; i < carrosSinRepetidos.length; i++) {
        ...
        if (objP.cantidad > 0) {
            ...
            botonEliminar.classList.add("btn", "btn-danger", "mr-2"); // Clases de Bootstrap, ajusta según tu estilo

            // Crear el texto del producto con subtotal
            var textoProducto = document.createTextNode(objP.cantidad + "- " + objP.nombre + " - $ " + objP.precio + " sub total -" + (objP.cantidad * objP.precio)+"                    ");
